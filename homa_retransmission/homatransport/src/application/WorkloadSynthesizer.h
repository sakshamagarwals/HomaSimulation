...
class WorkloadSynthesizer : public cSimpleModule
{
  ...
  PROTECTED:
    ...
    // static simsignal_t msgCompleteSizeSignal;
    //static simsignal_t KBMsgSendSignal;
    static simsignal_t KBMsgReceivedSignal;

    //static simsignal_t KBMsgSendBytesSignal;
    //static simsignal_t KBMsgReceivedBytesSignal;
