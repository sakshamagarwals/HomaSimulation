//
// Generated file, do not edit! Created by nedtool 4.6 from transport/HomaPkt.msg.
//
...
EXECUTE_ON_STARTUP(
    ...
    e->insert(RESEND, "RESEND");
    e->insert(MSG_ACK, "MSG_ACK");
);
...
void doPacking(cCommBuffer *b, ResendFields& a)
{
    doPacking(b,a.resendBytes);
    doPacking(b,a.offset);
}

void doUnpacking(cCommBuffer *b, ResendFields& a)
{
    doUnpacking(b,a.resendBytes);
    doUnpacking(b,a.offset);
}

class ResendFieldsDescriptor : public cClassDescriptor
{
  public:
    ResendFieldsDescriptor();
    virtual ~ResendFieldsDescriptor();
...
Register_ClassDescriptor(ResendFieldsDescriptor);

ResendFieldsDescriptor::ResendFieldsDescriptor() : cClassDescriptor("ResendFields", "")
{
}

ResendFieldsDescriptor::~ResendFieldsDescriptor()
{
}

bool ResendFieldsDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<ResendFields *>(obj)!=NULL;
}

const char *ResendFieldsDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int ResendFieldsDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount(object) : 2;
}

unsigned int ResendFieldsDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *ResendFieldsDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int ResendFieldsDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='r' && strcmp(fieldName, "resendBytes")==0) return base+0;
    if (fieldName[0]=='o' && strcmp(fieldName, "offset")==0) return base+1;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *ResendFieldsDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *ResendFieldsDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int ResendFieldsDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    ResendFields *pp = (ResendFields *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string ResendFieldsDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    ResendFields *pp = (ResendFields *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->resendBytes);
        case 1: return ulong2string(pp->offset);
        default: return "";
    }
}

bool ResendFieldsDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    ResendFields *pp = (ResendFields *)object; (void)pp;
    switch (field) {
        case 0: pp->resendBytes = string2ulong(value); return true;
        case 1: pp->offset = string2ulong(value); return true;
        default: return false;
    }
}

const char *ResendFieldsDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *ResendFieldsDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void HomaPkt_Base::copy(const HomaPkt_Base& other)
{
    ...
    this->resendFields_var = other.resendFields_var;
}
...
void HomaPkt_Base::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->resendFields_var);
}
...
void HomaPkt_Base::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->resendFields_var);
}
...
ResendFields& HomaPkt_Base::getResendFields()
{
    return resendFields_var;
}

void HomaPkt_Base::setResendFields(const ResendFields& resendFields)
{
    this->resendFields_var = resendFields;
}
...
int HomaPktDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "resendFields")==0) return base+8;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string HomaPktDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: {std::stringstream out; out << pp->getResendFields(); return out.str();}
        default: return "";
    }
}
...
const char *HomaPktDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 8: return opp_typename(typeid(ResendFields));
        default: return NULL;
    };
}
...
void *HomaPktDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return (void *)(&pp->getResendFields()); break;
        default: return NULL;
    }
}
