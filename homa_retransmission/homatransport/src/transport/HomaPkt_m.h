...
/**
 * Enum generated from <tt>transport/HomaPkt.msg:25</tt> by nedtool.
 * <pre>
 * enum PktType
 * {
 * 
...
/**
 * Struct generated from transport/HomaPkt.msg:35 by nedtool.
 */
...
/**
 * Struct generated from transport/HomaPkt.msg:57 by nedtool.
 */
struct GrantFields
{
    GrantFields();
...
/**
 * Struct generated from transport/HomaPkt.msg:70 by nedtool.
 */
...
/**
 * Struct generated from transport/HomaPkt.msg:77 by nedtool.
 */
struct ResendFields
{
    ResendFields();
    uint16_t resendBytes;
    uint32_t offset;
};
...
/**
 * Class generated from <tt>transport/HomaPkt.msg:93</tt> by nedtool.
 * <pre>
 * //
 ...
 * 
 *     ResendFields resendFields;          //Used only for RESEND
 * 
 * 
 * }
 * </pre>
...
class HomaPkt_Base : public ::cPacket
{
  ...
  public:
    ...
    virtual ResendFields& getResendFields();
    virtual const ResendFields& getResendFields() const {return const_cast<HomaPkt_Base*>(this)->getResendFields();}
    virtual void setResendFields(const ResendFields& resendFields);
};
