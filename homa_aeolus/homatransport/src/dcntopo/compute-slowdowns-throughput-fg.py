...
slowdownfile = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'slowdown.txt'
throughputfile = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'throughput.txt'
slowdown_sizefile = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'slowdown_size.txt'
plotfile = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'octbins.eps'
plotfile_png = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'octbins.png'
octbinsfile = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'octbins.txt'
flowsizebinsfile = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'flowsizebins_avg.txt'
flowsizebinsfile_99 = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'flowsizebins_99.txt'
plotfile_flowsizes = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'flowsizebins.eps'
plotfile_flowsizes_png = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'flowsizebins.png'

flowsizebinsfile_bdp = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'flowsizebins_avg_bdp.txt'
flowsizebinsfile_99_bdp = 'results/b-100-a-0.0-fg-128kb-bg-dctcp-3x/FG-result-' + EXP  + 'flowsizebins_99_bdp.txt'
bdp = 50 * 1500
